<template>
  <div>
    <div>
      ...
      <el-row>
        <el-form style="text-align: right; margin-right: 5px;" size="mini" :inline="true">
          ...
          <el-form-item label="设备ARP_IP">
            <el-input placeholder="arp" v-model="filter_arp" @keyup.enter.native="getViews" clearable></el-input>
          </el-form-item>
          <el-form-item label="设备名">
            <el-input placeholder="sysname" v-model="filter_name" @keyup.enter.native="getViews" clearable></el-input>
          </el-form-item>
          <el-form-item label="接口名">
            <el-input placeholder="if name" v-model="filter_ifname" @keyup.enter.native="getViews" clearable></el-input>
          </el-form-item>
          <el-form-item>
    ...
    <el-table border :data.sync='table_info_show' @selection-change="handleSelectionChange" :default-sort = "{prop: 'port_id'}" border size="mini">
      ...
      <el-table-column prop='arp_mac' label='MAC' show-overflow-tooltip min-width='10' align='center'>
      </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getViews(){
        ...
        this.filter_arp = this.filter_arp.replace(/^\s*|\s*$/g,"")
        if(this.filter_arp!=""){
          post_data["arp_ip"]=this.filter_arp
        }
        ...
        collector_api.getARPList(post_data,{}).then(function(response){
